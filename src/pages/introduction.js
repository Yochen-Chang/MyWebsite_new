...
const IntroductionPage = () => {
  return (
    <>
      <Layout pageClass="introduction">
      <div id="chatBoxBg" class="container vw-70">
        <div id="chat1" class="mychat flexSSRow animation-fadeIn">
          <StaticImage
            className="avator m-1"
            alt=""
            src="../images/icons/Avator-Me.png"
          />
          <div class="chatBox dis-ib m-1 p-1 shadow-rb">
            你好，我是張祐誠，現在正積極尋找前端工程師的職缺！
          </div>
        </div>
        <div id="chat2" class="femaleChat flexESRow animation-fadeIn">
          <div class="chatBox dis-ib m-1 p-1 shadow-lb">
            咦？為什麼會想找前端工程師的職缺呢？
          </div>
          <StaticImage
            className="avator m-1"
            alt=""
            src="../images/icons/Avator-Female.png"
          />
        </div>
        <div id="chat3" class="myChat flexSSRow animation-fadeIn">
            <StaticImage
                className="avator m-1"
                alt=""
                src="../images/icons/Avator-Me.png"
        ...
        <div id="chat4" class="maleChat flexESRow animation-fadeIn">
          <div class="chatBox dis-ib m-1 p-1 shadow-lb">
            覺得自己很適合？為什麼會這麼說呢？
          </div>
          <StaticImage
            className="avator m-1"
            alt=""
            src="../images/icons/Avator-Male.png"
          />
        </div>
        <div id="chat5" class="myChat flexSSRow animation-fadeIn">
        <StaticImage
            className="avator m-1"
            alt=""
            src="../images/icons/Avator-Me.png"
          ...
          <div class="chatBox chatBoxDiv dis-ib m-1 p-1 shadow-rb animation-fadeIn">
        ...
        <div id="chat6" class="femaleChat flexESRow animation-fadeIn">
          <div class="chatBox dis-ib m-1 p-1 shadow-lb">
        ...
        <div id="chat7" class="myChat flexSSRow animation-fadeIn">
          <StaticImage
              className="avator m-1"
              alt=""
              src="../images/icons/Avator-Me.png"
        ...
        <div id="chat8" class="maleChat flexESRow animation-fadeIn">
          <div class="chatBox dis-ib m-1 p-1 shadow-lb">
        ...
        <div id="chat9" class="myChat flexSSRow animation-fadeIn">
          <StaticImage
            className="avator m-1"
            alt=""
            src="../images/icons/Avator-Me.png"
        ...
        <div id="chat10" class="maleChat flexESRow animation-fadeIn">
          <div class="chatBox dis-ib m-1 p-1 shadow-lb">
        ...
        <div id="chat11" class="femaleChat flexESRow animation-fadeIn">
          <div class="chatBox dis-ib m-1 p-1 shadow-lb">
        ...
        <div id="chat12" class="myChat flexSSRow animation-fadeIn">
          <StaticImage
              className="avator m-1"
              alt=""
              src="../images/icons/Avator-Me.png"
        ...
        <div id="chat13" class="maleChat flexESRow animation-fadeIn">
          <div class="chatBox dis-ib m-1 p-1 shadow-lb">
        ...
        <div id="chat14" class="myChat flexSSRow animation-fadeIn">
          <StaticImage
              className="avator m-1"
              alt=""
              src="../images/icons/Avator-Me.png"
        ...
        <div id="chat15" class="femaleChat flexESRow animation-fadeIn">
          <div class="chatBox dis-ib m-1 p-1 shadow-lb">
        ...
        <div id="chat16" class="myChat flexSSRow animation-fadeIn">
          <StaticImage
              className="avator m-1"
              alt=""
              src="../images/icons/Avator-Me.png"
        ...
        <div id="chat17" class="maleChat flexESRow animation-fadeIn">
          <div class="chatBox dis-ib m-1 p-1 shadow-lb typing">
            輸入中......
          </div>
          <StaticImage
            className="avator m-1"
...
export const Head = () => <title>Introduction | 🕺🏾會搖擺的網頁工程師👨🏻‍💻</title>;
